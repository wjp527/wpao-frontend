<template>
  <div class="mode">
    ...
    <div class="toggle-btn">
      <div class="ToggleSwitche">
      <div class="toggle-cont">
        <input class="toggle-input" id="toggle" name="toggle" type="checkbox" v-model="isChecked" />
...
<script lang="ts" setup name="ToggleSwitche">
...
// 当 isChecked 变化时，发出 update:modelValue 事件
// 保证本地的状态 同步到 父组件
...
.ToggleSwitche {
  /* 设置缩放比例 */
  transform: scale(0.3); /* 0.8 表示 80% 的缩放比例，可以调整 */
  transform-origin: top left; /* 缩放的基准点 */
  width: fit-content; /* 调整容器的宽度以适应缩放后的内容 */
  height: fit-content;
  display: flex;
}
